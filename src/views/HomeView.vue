    ...
    <section id="sobre-mi" class="relative scroll-mt-20 px-5 py-10 sm:px-6 sm:py-12">
      <div class="mx-auto w-full max-w-5xl">
        ...
        <div class="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <MotionReveal
            class="rounded-3xl border border-white/10 bg-[#0f1720]/70 p-5 shadow-lg shadow-black/15 backdrop-blur-md sm:p-6"
            :x="-14"
            :delay="0.08"
          >
          ...
          <div class="relative">
            ...
            <div class="space-y-5">
              ...
              >
                ...
                <button
                  type="button"
                  class="group overflow-hidden rounded-2xl border border-white/10 bg-[#0f1720]/76 text-left shadow-lg shadow-black/15 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-brand-violet/30 hover:shadow-brand-violet/10 md:col-span-1"
                ...
                >
                  <div class="relative h-32 overflow-hidden bg-space/70">
                    ...
                    <div class="absolute inset-0 bg-linear-to-t from-space/55 to-transparent"></div>
                  </div>
                  <div class="p-4">
